...
export const fetchVietJetFlights = async (searchData: SearchFormData): Promise<Flight[]> => {
  ...
  try {
    const response = await fetch('https://youth-yale-specialty-membership.trycloudflare.com/vj/check-ve-v2', {
      method: 'POST',
      headers: {
...
export const fetchVietnamAirlinesFlights = async (searchData: SearchFormData): Promise<Flight[]> => {
  ...
  try {
    const response = await fetch('https://youth-yale-specialty-membership.trycloudflare.com/vna/check-ve-v2', {
      method: 'POST',
      headers: {
        'accept': 'application/json',
        'Content-Type': 'application/json',
