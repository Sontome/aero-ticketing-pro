        ...
        <div className="space-y-6">
          ...
          {pnrData && (
            <div className="space-y-5 relative p-2">
              ...
              {!pnrData.paymentstatus && (
                <div className="px-4 py-3 rounded" style={{ backgroundColor: '#fffad6' }}>
                  <p className="text-lg text-black font-semibold">
                    Tổng tiền: <span className="text-red-600"> {Math.round(pnrData.tongbillgiagoc).toLocaleString('en-US')}</span> <span className="text-gray-800">KRW</span> 
                  </p>
                </div>
              )}
              ...
              <div
                ref={captureRef}
                className="[&_p]:m-0 [&_span]:m-0 [&_div]:leading-tight [&_p]:leading-tight"
              >
              ...
              <div className="bg-white p-4">
                ...
                <div className="flex flex-col gap-4">
                  {pnrData.chang.map((segment) => (
                    <div key={segment.sochang} className="border rounded-md border-[#E3EBF1] shadow p-4 px-6 text-base">
                      <div className="flex flex-col lg:flex-row w-full flex-wrap items-center gap-2 lg:gap-5">
                        ...
                        <div className="flex flex-col lg:flex-row items-center justify-center gap-1">
                          <div className="text-center mr-3 w-[120px] relative -translate-y-[8px]">
                            ...
                            <p className="text-base font-normal text-[#1B2132]">
                              {segment.ngaycatcanh}
                            </p>
                          </div>
