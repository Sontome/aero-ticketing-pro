...
export const EmailTicketModal = ({ isOpen, onClose }: EmailTicketModalProps) => {
  ...
  return (
    <Dialog open={isOpen} onOpenChange={handleClose}>
      <DialogContent className="sm:max-w-[600px] max-h-[80vh] overflow-y-auto animate-fade-in duration-700">
        <DialogHeader className="animate-fade-in duration-700">
        ...
        <form onSubmit={handleSubmit} className="space-y-4 animate-fade-in duration-700">
